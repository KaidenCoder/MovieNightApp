...
public class MoviesViewPager extends Fragment {

    private RecyclerView recyclerView;
    private List<CardDetails> moviesList;
    ...
    public void loadResultsPage(final int page) {
        ...
        try {
            ...
            Call<CardDetailsSource> call = apiService.getFilteredMovies(
                    API_KEY,
                    page,
                    ...
                    public void onResponse(@NonNull Call<CardDetailsSource> call,
                        ...
                        if (response.body() != null && response.code() == HttpURLConnection.HTTP_OK) {
                            ...
                            if (adapter == null) {
                                ...
                                adapter = new MediaAdapter(getContext(), moviesList);
    ...
    private FilterCardDetails getFilterFromSharedPreferences(){
        ...
        String minRatingString = sharedPrefs.getString(
                getString(R.string.pref_movie_min_vote_avg_key),
                getString(R.string.pref_movie_min_vote_avg_default_value));
        double minRating;
        try {
        ...
        String minVoteCountString = sharedPrefs.getString(
                getString(R.string.pref_movie_min_vote_count_key),
                getString(R.string.pref_movie_min_vote_count_default_value));
        int minVoteCount;
        try {
        ...
        String minReleaseDate = sharedPrefs.getString(
                getString(R.string.pref_movie_min_release_date_key),
                getString(R.string.pref_movie_min_release_date_default_value));

        String maxReleaseDate = sharedPrefs.getString(
                getString(R.string.pref_movie_max_release_date_key),
                getString(R.string.pref_movie_max_release_date_default_value));

        String originalLanguage = sharedPrefs.getString(
                getString(R.string.pref_movie_original_language_key),
                getString(R.string.pref_movie_original_language_default_value));

        String sortBy = sharedPrefs.getString(
                getString(R.string.pref_movie_sort_by_key),
                getString(R.string.pref_movie_sort_by_default_value));

        // Get CardDetails genre preferences
        final Set<String> prefGenresDefaultValues = new HashSet<>();
        prefGenresDefaultValues.addAll(Arrays.asList(
                getResources().getStringArray(R.array.pref_movie_genres_default_values)));
        Set<String> genresSet = sharedPrefs.getStringSet(
                getString(R.string.pref_movie_genres_key),prefGenresDefaultValues);
